			...
			<div class="table-wrapper products-table">
                    ...
                    <div class="row-fluid filter-block">
                        <#--<div class="pull-right">-->
                            <#--<a href="alarm_query_for_deleteTrigger.action" class="btn-flat info">告警过滤...</a>-->
                        <#--</div>-->
                        <div class="pull-right">
                            <a href="history_alarms.action" class="btn-flat info">历史告警...</a>
                        </div>
                        <#--<div class="pull-right">-->
                            <#--<a href="alarm_sms_stat.action" class="btn-flat info">告警短信查询...</a>-->
                        <#--</div>-->
